...
subroutine advance
  ...
  ! write(6,"(/a)") "external mode started"
  ...
  ! write(6,"(/a)") "external mode finished"
  ...
  !write(6,"(/a)") "internal mode finished"
...
subroutine check_nan(varname, im, jm, km, dat)
  use common_pom_var, only: iint, my_task
  use mpi
